...
{
    public MultiLanguageText mutiLanguagetext;
    public MultiLanguageSprite mutiLanguagesprite;

    public MultiLanguageOption(MultiLanguageText mutiLanguagetext, MultiLanguageSprite mutiLanguagesprite)
    {
        this.mutiLanguagetext = mutiLanguagetext;
        this.mutiLanguagesprite = mutiLanguagesprite;
    }    
}
...
public class Localization : MonoBehaviour
{
    ...
    public MultiLanguageSprite multiLanguageSprite;

    //AduioClip
    private AudioSource audioSource;
    public MultiLanguageAudioClip multiLanguageAudioClip;
    ...
    private void Awake()
    {
        ...
        switch (dataType)
        {
            ...
            case LocalizationDataType.Dropdown:
                ...
                {
                    languageManager.Register(option.mutiLanguagetext);
                    languageManager.Register(option.mutiLanguagesprite);
                }
                break;
    ...
    public bool GetLanguageManager()
    {
            ...
            case LocalizationDataType.Dropdown:
                for (int i = 0; i < dropdown.options.Count; i++)
                {
                    if (multiLanguageOptions[i] != null)
                    {
                        ...
                        dropdown.options[i].text = option.mutiLanguagetext.currentTranslation;
                        dropdown.options[i].image = option.mutiLanguagesprite.currentTranslation;
                    }
                }
                break;
            case LocalizationDataType.DropdownTextMeshPro:
                for (int i = 0; i < tmpDropdown.options.Count; i++)
                {
                    ...
                    {
                        MultiLanguageOption option = multiLanguageOptions[i];
                        tmpDropdown.options[i].text = option.mutiLanguagetext.currentTranslation;
                        tmpDropdown.options[i].image = option.mutiLanguagesprite.currentTranslation;
                    }
                }
                break;
            case LocalizationDataType.Image:
    ...
    private void RemoveLocalization()
    {
        ...
        foreach(MultiLanguageOption option in multiLanguageOptions)
        {
            languageManager.Remove(option.mutiLanguagetext);
            languageManager.Remove(option.mutiLanguagesprite);
        }
    }
