...
{
    private SerializedProperty languageManagementProp;
    ...
    private void OnEnable()
    {
        ...
        languageManagementProp = serializedObject.FindProperty("languageManager");
    ...
    public override void OnInspectorGUI()
    {
        ...
        // 参数
        EditorGUILayout.PropertyField(languageManagementProp);
